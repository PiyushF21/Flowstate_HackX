  ...
  return (
    <div className="h-full bg-surface-elevated rounded-2xl border border-border flex flex-col overflow-hidden">
      ...
      <div className="px-6 py-5 border-b border-border flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-text-primary font-display">{mockData.mcName} — Weekly Performance</h2>
          <p className="text-sm text-text-secondary mt-1">{mockData.period} • Generated by PRESCIENT</p>
        </div>
